...
class Job(object):
  ...
  def __init__(self, func, args=None, delay=0, periodic=False):
    if args is None:
      args = []
    self.func = func
    self.args = args
...
class JobQueue(object):
  ...
  def add_job(self, func, args=None, delay=0, periodic=False):
    ...
    """
    new_job = Job(func, delay=delay, args=args, periodic=periodic)
